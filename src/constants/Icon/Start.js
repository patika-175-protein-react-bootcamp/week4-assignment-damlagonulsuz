...
function Start() {
    return(
        <div>
            <svg width="300" height="139" viewBox="0 0 447 139" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <Button path = "../pages/Questions" text = "Start" /> */}
            <text x="0" y="0" fontSize={60} fill='white'>Start</text>
